...
### Things to know
1. Three things must be changed in the code for the bot to function with your own server
  ...
  c. The last line is your client token. If you are hosting the bot yourself you need to replace the text where it says with your unique        client token. More information on how to set up and host the bot yourself can be found in the setupInstructions.docx file.
